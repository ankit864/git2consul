  ...
  var handle_properties_kv_file = function(file_path, common_properties_relative_path, kvs, cb) {
    ...
    fs.readFile(file_path, {encoding: 'utf8'}, function (err, file_body) {
      ...
      if(common_properties_relative_path) {
        ...
        var path_to_common_properties_file = "/home/gitlab-runner/common.properties";
        fs.readFile(path_to_common_properties_file, {encoding: 'utf8'}, function (err, common_body) {
          ...
          logger.warn("path_to_common_properties_file global file success " + global.config_file);
        ...
        var path_to_common_properties_file = "/home/gitlab-runner/common.properties";
        logger.warn("path_to_common_properties_file global file " + global.config_file);
        logger.warn("path_to_common_properties_file global file success " + global.gproperties);
